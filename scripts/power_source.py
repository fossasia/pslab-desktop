...
class Power_source:
    ...
    def set_config(self, pcs_value, pv1_value, pv2_value, pv3_value):
        self.power_supply.pcs.current = pcs_value / 1000  # mA
        self.power_supply.pv1.voltage = pv1_value
        self.power_supply.pv2.voltage = pv2_value
        self.power_supply.pv3.voltage = pv3_value

    def get_config(self):
        output = {'type': 'GET_CONFIG_PWR_SRC',
                  'pcs': self.power_supply.pcs.current,
                  'pv1': self.power_supply.pv1.voltage,
                  'pv2': self.power_supply.pv2.voltage,
                  'pv3': self.power_supply.pv3.voltage}
    ...
    def save_config(self, data_path):
        ...
        self.file_write.save_config(
            ...
            pcs=self.power_supply.pcs.current, pv1=self.power_supply.pv1.voltage, pv2=self.power_supply.pv2.voltage,
            pv3=self.power_supply.pv3.voltage)
