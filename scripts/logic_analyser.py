...
class LogicAnalyser:
    ...
    def set_config(self, number_of_channels, trigger1_type, trigger2_type, trigger3_type, trigger4_type):
        ...
        self.trigger1_type = trigger1_type
        self.trigger2_type = trigger2_type
        self.trigger3_type = trigger3_type
        self.trigger4_type = trigger4_type

    def get_config(self):
        output = {'type': 'GET_CONFIG_OSC',
                  'timeBase': self.number_of_channels,
    ...
    def capture(self):
        ...
        if self.number_of_channels == 1:
            ...
            v2 = self.device.dchans[1].get_yaxis().tolist()
            ...
            v3 = self.device.dchans[2].get_yaxis().tolist()
            ...
            v4 = self.device.dchans[3].get_yaxis().tolist()
        output = {
            'type': 'START_LA',
            'ts1': ts1,
            'v1': v1,
