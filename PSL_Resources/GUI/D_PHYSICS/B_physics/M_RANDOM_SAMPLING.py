...
class AppWindow(QtGui.QMainWindow, template_graph_nofft.Ui_MainWindow, utilitiesClass):
    def __init__(self, parent=None, **kwargs):
        ...
        self.WidgetLayout.addWidget(
            self.dualButtonIcon(A='START', B='STOP', FUNCA=self.start, FUNCB=self.stop, TITLE='sampling'))
        self.WidgetLayout.addWidget(
            self.dualButtonIcon(A='Sinusoidal', B='Triangular', FUNCA=self.set_sine, FUNCB=self.set_tria,
                                TITLE='W1 type'))
