...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QtCore.QObject.connect(self.comboBox, QtCore.SIGNAL(_fromUtf8("currentIndexChanged(int)")),
                               MainWindow.setPendulumType)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_4.setToolTip(
            _translate("MainWindow", "Obtain average of data points selected in the table", None))
