...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.CH1GainBox.setGeometry(QtCore.QRect(127, 10, 91, 21))
        ...
        self.CH3_ENABLE = QtWidgets.QCheckBox(self.frame_11)
        self.CH3_ENABLE.setGeometry(QtCore.QRect(0, 90, 21, 20))
        self.CH3_ENABLE.setText("")
        self.CH3_ENABLE.setChecked(False)
        self.CH3_ENABLE.setObjectName("CH3_ENABLE")
        ...
        self.MIC_ENABLE = QtWidgets.QCheckBox(self.frame_11)
        self.MIC_ENABLE.setGeometry(QtCore.QRect(130, 90, 21, 20))
        self.MIC_ENABLE.setText("")
        self.MIC_ENABLE.setChecked(False)
        self.MIC_ENABLE.setObjectName("MIC_ENABLE")
        self.CH2_LABEL_3 = QtWidgets.QLabel(self.frame_11)
        self.CH2_LABEL_3.setGeometry(QtCore.QRect(150, 90, 131, 21))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.CH2_LABEL_3.setFont(font)
        self.CH2_LABEL_3.setObjectName("CH2_LABEL_3")
        self.CH2_LABEL_4 = QtWidgets.QLabel(self.frame_11)
        self.CH2_LABEL_4.setGeometry(QtCore.QRect(230, 50, 51, 21))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.CH2_LABEL_4.setFont(font)
        self.CH2_LABEL_4.setObjectName("CH2_LABEL_4")
        self.CH2GainBox = QtWidgets.QComboBox(self.frame_11)
        self.CH2GainBox.setGeometry(QtCore.QRect(130, 50, 91, 21))
...
"                                                                ")
        ...
        self.fit_type_box.addItem("")
        self.fourierMode = QtWidgets.QCheckBox(self.frame_6)
        self.fourierMode.setGeometry(QtCore.QRect(5, 35, 161, 21))
        self.fourierMode.setObjectName("fourierMode")
        ...
        self.Liss_show.toggled['bool'].connect(MainWindow.enableXY)
        self.CH2GainBox.currentIndexChanged['int'].connect(MainWindow.setGainCH2)
        self.fourierMode.toggled['bool'].connect(MainWindow.setFourier)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.CH1_LABEL.setText(_translate("MainWindow", "Chan 1"))
        self.CH2_LABEL.setText(_translate("MainWindow", "Chan 2"))
        ...
        self.CH1GainBox.setItemText(8, _translate("MainWindow", "+/-160V"))
        self.label_30.setText(_translate("MainWindow", "Range"))
        self.label_31.setText(_translate("MainWindow", "Range"))
        self.CH2_LABEL_2.setText(_translate("MainWindow", "CH3(+/-3.3V)"))
        self.CH2_LABEL_3.setText(_translate("MainWindow", "CH4(MICrophone)"))
        self.CH2_LABEL_4.setText(_translate("MainWindow", "CH2"))
        ...
        self.CH2GainBox.setItemText(8, _translate("MainWindow", "+/-160V"))
        ...
        self.trigger_select_box.setItemText(0, _translate("MainWindow", "Chan 1"))
        self.trigger_select_box.setItemText(1, _translate("MainWindow", "Chan 2"))
        ...
        self.fit_type_box.setItemText(1, _translate("MainWindow", "SQUARE FIT"))
        self.fourierMode.setText(_translate("MainWindow", "Fourier Transform"))
        self.frame_3.setProperty("class", _translate("MainWindow", "PeripheralCollectionInner"))
        self.label.setText(_translate("MainWindow", "X-Y Mode"))
        self.pushButton.setText(_translate("MainWindow", "View"))
        self.Liss_show.setText(_translate("MainWindow", "Enable XY plot"))
        self.Liss_x.setItemText(0, _translate("MainWindow", "Chan 1"))
        self.Liss_x.setItemText(1, _translate("MainWindow", "Chan 2"))
        self.Liss_x.setItemText(2, _translate("MainWindow", "CH3"))
        self.Liss_x.setItemText(3, _translate("MainWindow", "MIC"))
        self.Liss_y.setItemText(0, _translate("MainWindow", "Chan 1"))
        self.Liss_y.setItemText(1, _translate("MainWindow", "Chan 2"))
        self.Liss_y.setItemText(2, _translate("MainWindow", "CH3"))
        self.Liss_y.setItemText(3, _translate("MainWindow", "MIC"))
