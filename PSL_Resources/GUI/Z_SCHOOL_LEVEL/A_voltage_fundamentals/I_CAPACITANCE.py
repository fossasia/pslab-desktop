...
class AppWindow(QtGui.QMainWindow, widget_layout.Ui_MainWindow, utilitiesClass):
    def __init__(self, parent=None, **kwargs):
        ...
        self.capmeter = self.wideButtonIcon(TITLE='Capacitance (CAP)', UNITS='F', FUNC=self.I.get_capacitance,
                                            TOOLTIP='Displays the value of a capacitor connected between CAP and GND')
