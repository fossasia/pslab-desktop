...
::
    ...
    This experiment is used to study ac generation
...
class AppWindow(QtGui.QMainWindow, template_graph_nofft.Ui_MainWindow, utilitiesClass):
    def __init__(self, parent=None, **kwargs):
        ...
        self.voltmeter = self.displayIcon(TITLE='CH1 Voltage (Instantaneous)', UNITS='V',
                                          TOOLTIP='Displays instantaneous voltage on CH1 using the voltmeter')
        self.WidgetLayout.addWidget(self.voltmeter)

        self.fitmeter = self.displayIcon(TITLE='CH1 Fitted data', UNITS='V',
    ...
    def plotData(self):
        ...
        try:
            ...
            self.displayCrossHairData(self.plot, False, self.samples, self.I.timebase, [self.I.achans[0].get_yaxis()],
                                      [(0, 255, 0)])
    ...
    def crossHairEvent(self, plot, evt):
        ...
        if plot.sceneBoundingRect().contains(pos):
            ...
            self.displayCrossHairData(plot, False, self.samples, self.I.timebase, [self.I.achans[0].get_yaxis()],
                                      [(0, 255, 0)])
