...
class AppWindow(QtGui.QMainWindow, template_graph_nofft.Ui_MainWindow, utilitiesClass):
    def __init__(self, parent=None, **kwargs):
        ...
        self.plot.setLimits(yMax=4, yMin=-4, xMin=0, xMax=self.samples * self.tg * 1e-6);
        ...
        self.res = self.spinIcon(TITLE='Resistance(R)', MIN=100, MAX=20000,
                                 TOOLTIP="Enter the value of the resistor you connected between CH1 and GND",
                                 FUNC=lambda x: x, UNITS=u"\u03A9")
    ...
    def plotData(self):
        ...
        try:
            ...
            try:
                ...
                self.applySIPrefix((RMS2 - RMS1) / I, u"\u03A9"), self.applySIPrefix(I, 'A')))
            except:
                pass
