...
::
    ...
    This experiment is used to study Ohm's Law
...
class AppWindow(QtGui.QMainWindow, graph_and_sheet.Ui_MainWindow, utilitiesClass):
    def __init__(self, parent=None, **kwargs):
        ...
        for a in range(50):
            ...
            item = QtGui.QTableWidgetItem();
            item.setText('');
            self.table.setItem(a, 2, item)

        self.current = 0;
        self.readings = 0

        cr_icon = self.addPCS(self.I, self.setCurrent);
        self.WidgetLayout.addWidget(cr_icon);
        cr_icon.setValue(100)
