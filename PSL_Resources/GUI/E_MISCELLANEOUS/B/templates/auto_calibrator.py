...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Button480pF = QtWidgets.QPushButton(self.frame_4)
        self.Button480pF.setObjectName("Button480pF")
        self.verticalLayout.addWidget(self.Button480pF)
        self.Button1uF = QtWidgets.QPushButton(self.frame_4)
        self.Button1uF.setObjectName("Button1uF")
        self.verticalLayout.addWidget(self.Button1uF)
        self.Button100uF = QtWidgets.QPushButton(self.frame_4)
        self.Button100uF.setObjectName("Button100uF")
        self.verticalLayout.addWidget(self.Button100uF)
        self.ButtonCCS = QtWidgets.QPushButton(self.frame_4)
        self.ButtonCCS.setObjectName("ButtonCCS")
        self.verticalLayout.addWidget(self.ButtonCCS)
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout.addItem(spacerItem)
        self.gridLayout_2.addWidget(self.frame_4, 1, 2, 1, 1)
        self.deviceBox = QtWidgets.QComboBox(self.frame_2)
        ...
        self.Button480pF.clicked.connect(MainWindow.cap480)
        self.Button1uF.clicked.connect(MainWindow.cap1)
        self.Button100uF.clicked.connect(MainWindow.cap100)
        self.ButtonCCS.clicked.connect(MainWindow.ccs)
        self.pushButton_4.clicked.connect(MainWindow.setDifferentAD7718)
        self.comboBox.currentIndexChanged['QString'].connect(MainWindow.setINL_CHANNEL)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "INL Channel"))
        self.dirnameLabel.setText(_translate("MainWindow", ":calibration_data"))
        self.comboBox.setItemText(0, _translate("MainWindow", "AN8"))
        self.comboBox.setItemText(1, _translate("MainWindow", "CAP"))
        ...
        self.Button480pF.setText(_translate("MainWindow", "480pF"))
        self.Button1uF.setText(_translate("MainWindow", "1uF"))
        self.Button100uF.setText(_translate("MainWindow", "100uF"))
        self.ButtonCCS.setText(_translate("MainWindow", "CCS"))
        self.pushButton_4.setToolTip(_translate("MainWindow", "Select different device for 24-bit ADC"))
        self.pushButton_4.setText(_translate("MainWindow", "Select precision ADC"))
