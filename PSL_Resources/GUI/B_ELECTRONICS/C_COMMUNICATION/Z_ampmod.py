...
class AppWindow(QtGui.QMainWindow, ampMod.Ui_MainWindow, utilitiesClass):
    def __init__(self, parent=None, **kwargs):
        ...
        a1 = {'TITLE': 'W2(Carrier)', 'MIN': 10, 'MAX': 5000, 'FUNC': self.I.set_w2, 'TYPE': 'dial', 'UNITS': 'Hz',
        ...
        a1 = {'TITLE': 'W1(Mod)', 'MIN': 10, 'MAX': 500, 'FUNC': self.I.set_w1, 'TYPE': 'dial', 'UNITS': 'Hz',
    ...
    def start_captureNORMAL(self):
        ...
        try:
            ...
            if self.active_channels:
                ...
                self.I.capture_traces(self.active_channels, self.samples, self.timebase, 'CH1', 0,
            ...
            if fitsel.currentIndex() < 2:
                ...
                if self.channel_states[fitsel.currentIndex()]:
                    if fitsel.currentText() == 'CH2':
                        ...
                        ed = self.fitData(self.I.achans[fitsel.currentIndex()].get_xaxis(),
                                          self.I.achans[fitsel.currentIndex()].get_yaxis(), self.curveFL)
