...
from PSL_Apps.templates import auto_template_graph as template_graph
...
params = {
    ...
    'name': 'Diode\nClipping',
    'hint': '''
	Study Clipping Circuits using diodes.<br>
...
class AppWindow(QtGui.QMainWindow, template_graph.Ui_MainWindow, utilitiesClass):
    def __init__(self, parent=None, **kwargs):
        ...
        bias = self.addPV3(self.I);
        bias.dial.setValue(2048)
        self.WidgetLayout.addWidget(bias)
