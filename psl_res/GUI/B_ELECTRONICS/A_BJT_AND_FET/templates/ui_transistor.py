...
# Form implementation generated from reading ui file 'seel_res/GUI/B_ELECTRONICS/A_BJT_AND_FET/templates/transistor.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.optionsBox = QtGui.QComboBox(self.frame)
        ...
        QtCore.QObject.connect(self.plotButton, QtCore.SIGNAL(_fromUtf8("clicked()")), MainWindow.run)
        QtCore.QObject.connect(self.optionsBox, QtCore.SIGNAL(_fromUtf8("currentIndexChanged(int)")), MainWindow.typeChanged)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sweepLabel.setText(_translate("MainWindow", "sweep", None))
        ...
        self.biasLabel.setText(_translate("MainWindow", "bias", None))
