...
# Form implementation generated from reading ui file 'psl_res/GUI/A_TEST_AND_MEASUREMENT/A_TandM/templates/arbitStream.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pause = QtGui.QCheckBox(self.frame)
...
"color: rgb(255, 255, 255);"))
        ...
        QtCore.QObject.connect(self.spinBox, QtCore.SIGNAL(_fromUtf8("valueChanged(int)")), MainWindow.setDelay)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.spinBox.setSuffix(_translate("MainWindow", " mS", None))
