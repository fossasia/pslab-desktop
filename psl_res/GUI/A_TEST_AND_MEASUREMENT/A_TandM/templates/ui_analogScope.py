...
# Form implementation generated from reading ui file 'psl_res/GUI/A_TEST_AND_MEASUREMENT/A_TandM/templates/analogScope.ui'
#
# Created: Mon Aug 22 01:30:36 2016
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.CH1GainBox.setItemText(8, _translate("MainWindow", "+/-160V", None))
        ...
        self.CH2GainBox.setItemText(8, _translate("MainWindow", "+/-160V", None))
        ...
        self.trigger_select_box.setItemText(0, _translate("MainWindow", "Chan 1", None))
        self.trigger_select_box.setItemText(1, _translate("MainWindow", "Chan 2", None))
        ...
        self.Liss_x.setItemText(0, _translate("MainWindow", "Chan 1", None))
        self.Liss_x.setItemText(1, _translate("MainWindow", "Chan 2", None))
        self.Liss_x.setItemText(2, _translate("MainWindow", "CH3", None))
        self.Liss_x.setItemText(3, _translate("MainWindow", "MIC", None))
        self.Liss_y.setItemText(0, _translate("MainWindow", "Chan 1", None))
        self.Liss_y.setItemText(1, _translate("MainWindow", "Chan 2", None))
