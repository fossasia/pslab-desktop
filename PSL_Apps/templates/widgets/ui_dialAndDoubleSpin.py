...
# Form implementation generated from reading ui file 'PSL_Apps/templates/widgets/dialAndDoubleSpin.ui'
#
...
""))
        ...
        self.value = QtGui.QDoubleSpinBox(self.ImageFrame)
        ...
        QtCore.QObject.connect(self.value, QtCore.SIGNAL(_fromUtf8("editingFinished()")), Form.setDoubleValue)
    ...
    def retranslateUi(self, Form):
        ...
        self.value.setSuffix(_translate("Form", " ", None))
