...
# Form implementation generated from reading ui file 'dualButton.ui'
#
...
"")
        ...
        self.buttonB.clicked.connect(Form.clickedB)
        self.buttonA.clicked.connect(Form.clickedA)
