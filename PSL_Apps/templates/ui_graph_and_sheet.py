...
# Form implementation generated from reading ui file 'PSL_Apps/templates/graph_and_sheet.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 520, 439))
        ...
        self.gridLayout.addWidget(self.frame_3, 2, 1, 1, 2)
        ...
        self.table_area = QtGui.QVBoxLayout(self.frame_5)
        self.table_area.setSpacing(0)
        ...
        self.table_area.addWidget(self.table)
        ...
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), MainWindow.plotData)
        QtCore.QObject.connect(self.pushButton_3, QtCore.SIGNAL(_fromUtf8("clicked()")), MainWindow.clearData)
