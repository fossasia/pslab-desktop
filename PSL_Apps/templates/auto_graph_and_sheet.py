...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_5 = QtWidgets.QFrame(self.widgetFrameOuter)
        self.frame_5.setMaximumSize(QtCore.QSize(300, 16777215))
        self.frame_5.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_5.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_5.setObjectName("frame_5")
        self.table_area = QtWidgets.QVBoxLayout(self.frame_5)
        self.table_area.setContentsMargins(0, 0, 0, 0)
        self.table_area.setSpacing(0)
        self.table_area.setObjectName("table_area")
        self.table = QtWidgets.QTableWidget(self.frame_5)
        ...
        self.pushButton.clicked.connect(MainWindow.plotData)
        self.pushButton_3.clicked.connect(MainWindow.clearData)
