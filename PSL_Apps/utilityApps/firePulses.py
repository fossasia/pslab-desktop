...
class AppWindow(QtGui.QMainWindow, firePulses.Ui_MainWindow, utilitiesClass):
    def __init__(self, parent=None, **kwargs):
        ...
        self.setWindowTitle(
            'Fire Pulses on SQR1(beta. May cause comm errors) : ' + self.I.H.version_string.decode("utf-8"))
        self.table = myTable()
        self.tableLayout.addWidget(self.table)
        a1 = {'TITLE': 'SQR1', 'MIN': 100, 'MAX': 100000, 'FUNC': self.presetSQR1, 'TYPE': 'dial', 'UNITS': 'Hz',
